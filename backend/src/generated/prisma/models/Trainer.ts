...
export type TrainerWhereInput = {
  ...
  user_id?: Prisma.IntFilter<"Trainer"> | number
...
export type TrainerScalarWhereWithAggregatesInput = {
  ...
  user_id?: Prisma.IntWithAggregatesFilter<"Trainer"> | number
}
...
export type TrainerOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"user_id", ExtArgs["result"]["trainer"]>
...
export interface TrainerDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const trainerWithUser_idOnly = await prisma.trainer.findMany({ select: { user_id: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Trainers and only return the `user_id`
   * const trainerWithUser_idOnly = await prisma.trainer.createManyAndReturn({
   *   select: { user_id: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Trainers and only return the `user_id`
   * const trainerWithUser_idOnly = await prisma.trainer.updateManyAndReturn({
   *   select: { user_id: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface TrainerFieldRefs {
  readonly user_id: Prisma.FieldRef<"Trainer", 'Int'>
}
